/**
 * Immutable subset of builtin Set.
...
/**
 * Return true if and only if `a` is member of `s`
 */
 ...
 */
export const of = <Elements extends readonly unknown[]>(...[e0, ...rest]: Elements): ImmutableSet<Elements[number]> =>
  new Set(rest).add(e0)
...
export type SetsOf<A extends readonly unknown[]> = {
  [K in keyof A]: ImmutableSet<A[K]>
}
